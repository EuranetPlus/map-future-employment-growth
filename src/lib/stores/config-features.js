export const config = {
	mapTitle: 'future-employment-growth', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-future-employment-growth.vercel.app/', // The url provided when deploying the map on Vercel
